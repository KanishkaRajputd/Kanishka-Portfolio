    ...
    <>
      <div className="about center">
        <h1 data-aos="fade-right" className="mobileHead">
          Hello, I am <span className="about__name">Kanishka Rajput</span>
        </h1>
        <Type />
        ...
        <div className="about__contact center">
          <a
            href="https://github.com/KanishkaRajputd"
            aria-label="github"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="mailto:kanishka6393rajput@gmail.com"
            target="_blank"
            rel="noreferrer"
            aria-label="mail"
            className="link link--icon"
        ...
        <button
          ...
          onClick={() => {
            window.open(
              "https://docs.google.com/document/d/1aLpRlJQ1yt9rt7UL8zDnPMLUL0KWucsu7A2zbbFscJ4/edit?usp=sharing"
            );
          }}
        >
          Resume
